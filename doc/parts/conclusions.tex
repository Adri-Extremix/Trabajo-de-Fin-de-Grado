...
En este capitulo se prensentan las conclusiones del proyecto (\sectionref{conclusiones_proyecto}) y las conclusiones personales (\sectionref{conclusiones_personales}). También se describirán posibles mejoras al proyecto y diferentes frentes en los que se podría avanzar en próximos proyectos.
